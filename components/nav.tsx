...
export default function Nav() {
    ...
    return (
        <>
            <nav className='fixed bg-white z-50 border-b-2 border-gray-300 h-14 top-0 px-4  w-full items-center mx-auto  flex gap-4 justify-between '>
                ...
                <div className="flex gap-6  py-2 transition-all duration-200 ease-in-out">
                    ...
                    <span className={` ${isActive('/about')}  `}> <Link href={'/about'}> About me   </Link></span>

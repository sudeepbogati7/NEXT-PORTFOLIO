      ...
      <main className="mt-24">
        <div className='flex flex-col  items-center justify-center '>
          ...
          <div className='px-4 mt-14'>
            <div className='text-xl font-medium my-4 flex items-center gap-2 '> About me <Image objectFit='cover' className='h-6 w-6' src={'/about-me.png'} height={30} width={30} alt='about-me'></Image> </div>

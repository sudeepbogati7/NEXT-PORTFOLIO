      ...
      <main className="mt-24">
        <div className='flex flex-col  items-center justify-center '>
          ...
          <div className='flex gap-4 mt-4 '>
            ...
            <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-blue-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 320 512">
            ...
            <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-[#c13584]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512">
            ...
            <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-blue-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512">
            ...
            <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-orange-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 384 512">
            ...
            <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-green-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512">

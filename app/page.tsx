    ...
    <>
      ...
      <main className="mt-24">
        <div
          ...
          <div className='flex z-20 flex-col md:flex-row  justify-around w-4/5'>
            <div className='flex flex-col gap-4 md:gap-0 w-4/5 md:w-full mx-auto mb-2'>
              ...
              {/* <div className='text-3xl font-cursive'>Lets innovate Digital Solutions together {" :)"}</div> */}
              <div className='mx-auto w-fit'>
                <div className='z-20'><Image src={'/under_construction.png'} width={250} height={100} alt='under construction'></Image></div>
                <div> Site is under development............... </div>
              </div>
            </div>
